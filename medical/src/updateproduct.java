...
updateproduct()
{
    ...
    try
    {
        ...
        pst=c1.prepareStatement("select Name from makku");
        rs=pst.executeQuery();
        while(rs.next())
        {
...
public void actionPerformed(ActionEvent ae)
{
    ...
    try
    {
        ...
        {
            pst=c1.prepareStatement("update makku set price=? where name=?");
            pst.setString(1,r);
            pst.setString(2,p);
        ...
        if(u.equals(""))
        {
            JOptionPane.showMessageDialog(this,"please enter quantity to be update");
        }
        else
        {
            pst=c1.prepareStatement("update makku set quantity=? where name=?");
            pst.setString(1,u);
            pst.setString(2,o);
